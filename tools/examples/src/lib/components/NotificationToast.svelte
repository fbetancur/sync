...
<!-- Contenedor de notificaciones (fixed en la parte superior) -->
<div class="fixed top-4 right-4 z-50 flex flex-col gap-2 max-w-sm w-full px-4 pointer-events-none">
	{#each $notifications as notification (notification.id)}
		<div
			class="pointer-events-auto shadow-lg rounded-lg border p-4 flex items-start gap-3 {styles[notification.type]}"
