...
describe('BackgroundSyncManager', () => {
	...
	describe('isSupported', () => {
		...
		it('should return false when sync is not in ServiceWorkerRegistration', () => {
			...
			const originalSync = (global as any).ServiceWorkerRegistration.prototype.sync;
	...
	describe('registerSync', () => {
		it('should register sync with default tag', async () => {
			...
			expect(mockRegistration.sync.register).toHaveBeenCalledWith('credisync-sync');
		});
		...
		it('should register sync with custom tag', async () => {
			...
			expect(result).toBe(true);
			expect(mockRegistration.sync.register).toHaveBeenCalledWith('custom-sync');
		});
